...
# Modify default avahi
mv ./avahi ./feeds/packages/libs/avahi/files/avahi-daemon.conf
...
sed -i 's/START=.*/START=17/g' ./feeds/packages/net/zerotier/files/etc/init.d/zerotier
