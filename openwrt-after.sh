...
sed -i "s/set \${si}.disabled='\${defaults ? 0 : 1}'/set \${si}.disabled='0'/g" ./package/network/config/wifi-scripts/files/lib/wifi/mac80211.uc
...
cat >./feeds/packages/net/miniupnpd/files/upnpd.config <<\EEOF
config upnpd 'config'
	option enabled '1'
	...
	list internal_iface 'zerotier'
	option port '5000'
	option upnp_lease_file '/var/run/miniupnpd.leases'
	option igdv1 '1'
	option enable_upnp6 '1'
...
config perm_rule
	...
	option comment 'allow local lan'

config perm_rule
	option action 'allow'
	option ext_port '1024-65535'
	option int_addr '10.1.1.0/24'
	option int_port '1024-65535'
	option comment 'allow virtual lan'

config perm_rule
	option action 'deny'
	option ext_port '0-65535'
	option int_addr '0.0.0.0/0'
	option int_port '0-65535'
